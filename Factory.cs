        ...
        public Hull GenerateHull(int lvl)
        {
            ...
            switch (lvl)
            {
                case 1:
                    ...
                    Cost =  5000 * (hp/700 + 600/weigth + weaponNumber / 3 + armor/12)+ random.Next(2500, 3000);
                ...
                case 2:
                    ...
                    weaponNumber = 3;
                    Cost = 10000 * (hp / 700 + 600/weigth + weaponNumber / 3 + armor / 12) + random.Next(5000, 7500);
                    return new Hull(armor, hp, weigth, weaponNumber, Cost);
                case 3:
                    ...
                    Cost = 20000 * (hp / 700 + 600/weigth + weaponNumber / 3 + armor / 12) + random.Next(10000, 13000);
                    return new Hull(armor, hp, weigth, weaponNumber, Cost);
                case 4:
                    ...
                    weaponNumber = 4;
                    Cost = 40000 * (hp / 700 + 600/weigth + weaponNumber / 3 + armor / 12) + random.Next(20000, 25000);
                    return new Hull(armor, hp, weigth, weaponNumber, Cost);
                case 5:
                    ...
                    Cost = 55000 * (hp / 700 + 750/weigth + weaponNumber / 3 + armor / 12) + random.Next(45000, 65000);
                    return new Hull(armor, hp, weigth, weaponNumber, Cost);
                default:
        ...
        public Laser GenerateLaser(int lvl)
        {
            ...
            switch (lvl)
            {
                ...
                case 4:
                    ...
                    Cost = (int)(1250 * Math.Pow(Reliable, 2) + 1250 * (45 / weigth + atack /27) +random.Next(1000, 1200));
                    return new Laser(atack, weigth, 100, Reliable, Cost, 6);
                case 5:
                    Reliable = (float)random.Next(75, 99) / 100;
                    weigth = random.Next(13, 30);
                    atack = random.Next(50, 55);
                    Cost = (int)(2500 * Math.Pow(Reliable, 2) + 2500 * (45 / weigth + atack /27) +random.Next(2000, 2500));
        ...
        public FragmentaryCannon GenerateFragmentaryCannon(int lvl)
        {
            ...
            switch (lvl)
            {
                ...
                case 2:
                    ...
                    Cost = (int)(1000 * Math.Pow(Reliable, 2) + 1000 * (60 / weigth + atack / 45) + random.Next(1000, 2000));
                    return new FragmentaryCannon(atack, weigth, 100, Reliable, Cost, bulletCount);
                case 3:
                    Reliable = (float)random.Next(60, 99) / 100;
                    ...
                    Cost = (int)(2000 * Math.Pow(Reliable, 2) + 2000 * (60 / weigth + atack / 45) + random.Next(2000, 3000));
                    return new FragmentaryCannon(atack, weigth, 100, Reliable, Cost, bulletCount);
                case 4:
                    Reliable = (float)random.Next(70, 99) / 100;
                    weigth = random.Next(30, 60);
                    atack = random.Next(65, 80);
                    bulletCount = random.Next(3, 5);
                    Cost = (int)(4000 * Math.Pow(Reliable, 2) + 4000 * (60 / weigth + atack / 45) + random.Next(3000, 3500));
                    return new FragmentaryCannon(atack, weigth, 100, Reliable, Cost, bulletCount);
                case 5:
                    Reliable = (float)random.Next(75, 99) / 100;
                    weigth = random.Next(20, 40);
                    atack = random.Next(80, 95);
                    bulletCount = random.Next(3, 4);
                    Cost = (int)(8000 * Math.Pow(Reliable, 2) + 8000 * (60 / weigth + atack / 45) + random.Next(4500, 5500));
                    return new FragmentaryCannon(atack, weigth, 100, Reliable, Cost, bulletCount);
                default:
        ...
        public HeavyCannon GenerateHeavyCannon(int lvl)
        {
            ...
            switch (lvl)
            {
                case 1:
                    ...
                    atack = random.Next(35, 65);
                    penetration = random.Next(1, 3);
                ...
                case 2:
                    ...
                    atack = random.Next(45, 80);
                    penetration = random.Next(3, 6);
                    Cost = (int)(2000 * Math.Pow(Reliable, 2) + 2000 * (80 / weigth + atack / 75) +2000* penetration / 9 + random.Next(1500,2500));
                    return new HeavyCannon(atack, weigth, 100, Reliable, Cost, penetration);
                case 3:
                    Reliable = (float)random.Next(60, 99) / 100;
                    weigth = random.Next(50, 70);
                    atack = random.Next(50, 90);
                    penetration = random.Next(6, 9);
                    Cost = (int)(4000 * Math.Pow(Reliable, 2) + 4000 * (80 / weigth + atack / 75) + 4000*penetration / 9 + random.Next(3000,4000));
                    return new HeavyCannon(atack, weigth, 100, Reliable, Cost, penetration);
                case 4:
                    Reliable = (float)random.Next(70, 99) / 100;
                    weigth = random.Next(60, 95);
                    atack = random.Next(70, 115);
                    penetration = random.Next(10, 14);
                    Cost = (int)(6000 * Math.Pow(Reliable, 2) + 6000 * (80 / weigth + atack / 75) + 6000*penetration / 9 + random.Next(5000,7000));
                    return new HeavyCannon(atack, weigth, 100, Reliable, Cost, penetration);
                case 5:
                    Reliable = (float)random.Next(75, 99) / 100;
                    weigth = random.Next(60, 130);
                    atack = random.Next(90, 150);
                    penetration = random.Next(16, 20);
                    Cost = (int)(10000 * Math.Pow(Reliable, 2) + 10000 * (80 / weigth + atack / 75) + 10000*penetration / 9 + random.Next(7000,10000));
                    return new HeavyCannon(atack, weigth, 100, Reliable, Cost, penetration);
                default:
        ...
        public RocketLauncher GenerateRocketLuncher(int lvl)
        {
            ...
            switch (lvl)
            {
                ...
                case 2:
                    ...
                    atack = random.Next(35, 45);
                    Cost = (int)(1250 * Math.Pow(Reliable, 2) + 1250 * (40 / weigth + atack / 50) + random.Next(750, 1500));
                    return new RocketLauncher(atack, weigth, 100, Reliable, Cost, 30);
                case 3:
                    Reliable = (float)random.Next(60, 99) / 100;
                    weigth = random.Next(30, 50);
                    atack = random.Next(45, 55);
                    Cost = (int)(1750 * Math.Pow(Reliable, 2) + 1750 * (40 / weigth + atack / 50) + random.Next(3000, 4000));
                    return new RocketLauncher(atack, weigth, 100, Reliable, Cost, 45);
                case 4:
                    Reliable = (float)random.Next(70, 99) / 100;
                    weigth = random.Next(25, 45);
                    atack = random.Next(55, 65);
                    Cost = (int)(2500 * Math.Pow(Reliable, 2) + 2500 * (40 / weigth + atack / 50) + random.Next(4000, 5000));
                    return new RocketLauncher(atack, weigth, 100, Reliable, Cost, 45);
                case 5:
                    Reliable = (float)random.Next(75, 99) / 100;
                    weigth = random.Next(20, 35);
                    atack = random.Next(70, 90);
                    Cost = (int)(5000 * Math.Pow(Reliable, 2) + 5000 * (40 / weigth + atack / 50) + random.Next(6000, 7000));
        ...
        public Tetronik GenerateTetronik(int lvl)
        {
            ...
            switch (lvl)
            {
                case 1:
                    ...
                    atack = random.Next(40, 80);
                    bonusDamage = (float)random.Next(0, 13) / 100;
                    Cost = (int)(1500 * Math.Pow(Reliable, 2) + 750 * (1500 / weigth + atack / 100) + 1500*3*bonusDamage+ random.Next(1000, 2000));
                ...
                case 2:
                    ...
                    Cost = (int)(2500 * Math.Pow(Reliable, 2) + 2500 * (100 / weigth + atack / 100) + 2500 * 3 * bonusDamage + random.Next(2000,3000));
                    return new Tetronik(atack, weigth, 100, Reliable, Cost, bonusDamage);
                case 3:
                    Reliable = (float)random.Next(60, 99) / 100;
                    weigth = random.Next(70, 120);
                    atack = random.Next(80, 110);
                    bonusDamage = (float)random.Next(13, 27) / 100;
                    Cost = (int)(4000 * Math.Pow(Reliable, 2) + 4000 * (100 / weigth + atack / 100) + 4000 * 3 * bonusDamage + random.Next(4000, 5000));
                    return new Tetronik(atack, weigth, 100, Reliable, Cost, bonusDamage);
                case 4:
                    Reliable = (float)random.Next(70, 99) / 100;
                    weigth = random.Next(65, 120);
                    atack = random.Next(100, 140);
                    bonusDamage = (float)random.Next(20, 37) / 100;
                    Cost = (int)(9000 * Math.Pow(Reliable, 2) + 9000 * (100 / weigth + atack / 100) + 9000 * 3 * bonusDamage + random.Next(7000, 8000));
                    return new Tetronik(atack, weigth, 100, Reliable, Cost, bonusDamage);
                case 5:
                    Reliable = (float)random.Next(75, 99) / 100;
                    weigth = random.Next(75, 130);
                    atack = random.Next(130, 210);
                    bonusDamage = (float)random.Next(25, 49) / 100;
                    Cost = (int)(14000 * Math.Pow(Reliable, 2) + 14000 * (100 / weigth + atack / 100) + 14000 * 3 * bonusDamage + random.Next(12000, 150000));
                    return new Tetronik(atack, weigth, 100, Reliable, Cost, bonusDamage);
                default:
        ...
        public Vortex GenerateVortex(int lvl)
        {
            ...
            switch (lvl)
            {
                case 1:
                    Reliable = (float)random.Next(51, 99) / 100;
                    weigth = random.Next(50, 100);
                    atack = random.Next(20, 40);
                    shieldPenetration = random.Next(0, 5);
                ...
                case 2:
                    Reliable = (float)random.Next(55, 99) / 100;
                    weigth = random.Next(40, 80);
                    atack = random.Next(30, 60);
                    shieldPenetration = random.Next(3, 12);
                ...
                case 3:
                    ...
                    weigth = random.Next(30, 60);
                    atack = random.Next(40, 80);
                    shieldPenetration = random.Next(7, 20);
