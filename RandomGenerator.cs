...
namespace Projekt
{
    internal class RandomGenerator
    {
        ...
        public Player GeneratePlayer (int lvl , Planet localization)
        {
            ...
            return new Player("Random "+random.Next(0,9999), TempShip , random.Next((int)(1300+500*Math.Pow(lvl,2)), (int)(1500+700 * Math.Pow(lvl, 2))),localization );
        }
    }
}
